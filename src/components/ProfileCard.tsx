    ...
    <div ref={wrapRef} className={`pc-card-wrapper ${className}`.trim()} style={cardStyle as React.CSSProperties}>
      ...
      <div ref={shellRef} className={`pc-card-shell${isFlipped ? ' flipped' : ''}`}>
        ...
        <div className="pc-card-back">
          {/* Decorative elements */}
          <div className="pcb-deco-circle"></div>
          <div className="pcb-deco-dots"></div>

          <div className="pcb-inner">
            <div className="pcb-content">
              {avatarUrl && (
                <div className="pcb-avatar">
                  <div className="pcb-avatar-inner">
              ...
              <div className="pcb-info">
                <div className="pcb-field pcb-field-name">
                  <span className="pcb-label">Nama Lengkap</span>
                  <span className="pcb-value pcb-name-value">{namaLengkap || name}</span>
                </div>
                <div className="pcb-field-row">
                  <div className="pcb-field">
                    <span className="pcb-label">NRP</span>
                    <span className="pcb-value">{nrp || '—'}</span>
                  </div>
                  <div className="pcb-field">
                    <span className="pcb-label">Gugus</span>
                    <span className="pcb-value">{gugus || '—'}</span>
                  </div>
                </div>
              </div>
            </div>
